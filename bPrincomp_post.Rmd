...
ggplot(places_score, aes(x = Comp.1, y = Comp.2, 
                         label = city_id)) + geom_text() -> g
```

## Making a plot 3/3

```{r bPrincomp-22, fig.height=7}
g
```
