...
```{r inference-3-R-1}
my_url <- "../datafiles/duality.txt"
# my_url <- url("http://ritsokiguess.site/datafiles/duality.txt")
...
# my_url <- url("http://ritsokiguess.site/datafiles/irs.txt")
my_url <- "../datafiles/irs.txt"
irs <- read_csv(my_url)
irs
```
