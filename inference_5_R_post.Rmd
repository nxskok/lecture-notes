...
```{r inference-5-R-post-23, fig.height=6.5}
ggplot(rats,aes(y=density,x=fct_inorder(group)))+
geom_boxplot()
```
...
```{r inference-5-R-post-24, fig.height=6.5}
