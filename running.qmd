...
`library(tidyverse)`.
- Below that, make another "Header 2" and put "Weights of chickens" on that line.
- Make another new code cell below that, and insert the line of
code: `chickwts`
- Below that, make another Header 2, "A boxplot", and another code cell containing
`ggplot(chickwts, aes(x = feed, y = weight)) + geom_boxplot()`.

## My document

![](2024-07-09 13.56.58 r.datatools.utoronto.ca a3ab120e66da.png)
...
![](2024-07-09 14.01.27 r.datatools.utoronto.ca ee49aba03d21.png)
