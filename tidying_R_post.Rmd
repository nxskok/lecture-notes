...
```{r tidying-R-24}
my_url <- 
  "http://ritsokiguess.site/datafiles/toronto_weather.csv"
# my_url <- "../datafiles/toronto_weather.csv"
...
```{r tidying-R-26}
weather %>% 
  pivot_longer(starts_with("d"), names_to="day", 
...
```{r}
ggplot(weather_tidy, aes(x = date, y = tmax)) + geom_line(colour = "red") +
