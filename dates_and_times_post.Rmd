...
```{r dates-and-times-10, paged.print=T}
...
minutes, seconds:
```{r dates-and-times-15, paged.print=T}
(dd <- tibble(text = c(
...
```{r dates-and-times-16, paged.print=T}
