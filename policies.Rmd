...
1. In tutorial, you can expect to have a worksheet to work through or that the TA will lead you through some relevant examples, and that you will also have a chance to ask questions of the TA about the course material. (In STAD29, the tutorial is drop-in, where you are expected to bring your own questions or issues you want to raise.)
...
1. Assignments will be accepted up to 2 days late, with a penalty of 1% per hour until the assignment closes.
...
1. Assignments are *only* accepted on Quercus and must be readable by the grader in order to receive any credit. It is your responsibility to ensure that you have handed in the correct file. (Hint: in my courses, an R Markdown Notebook is not the correct file.) Assignments are not accepted by e-mail.
...
1. There is *no credit* for uncited ideas from outside the course.
...
1. Your grade in this class is based *only* on your mastery of the course content. It is *not* a reflection of how hard you worked, or how much effort you put into the course. Effort is not understanding, and is not the same as mastery of required course content or learning objectives.
...
1. Circumstances may change during the course. I reserve the right to adapt these policies as I see fit. If a policy change requires a class vote, a class vote will be taken.
