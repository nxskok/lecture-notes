...
## Grouped boxplot
```{r bAnova-post-10, fig.height=3.0}
ggplot(vitaminb, aes(
...
```{r bAnova-post-14, fig.height=3.7}
g
```
...
```{r bAnova-post-26, fig.height=2.7}
g
```
