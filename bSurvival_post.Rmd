...
```{r bSurvival-post-7, fig.height=3}
...
## Making the plot 
```{r bSurvival-post-28, fig.height=3.2}
...
```{r bSurvival-post-29, fig.height=3.8}
g
```
...
```{r bSurvival-post-30, ref.label="tidy-lung-3"}
```
...
```{r bSurvival-post-31, fig.height=3}
...
```{r bSurvival-post-34, fig.height=3.4, message=F}
...
```{r bSurvival-post-36, fig.height=3.2, message=F}
