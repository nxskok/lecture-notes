...
hilo %>% select(yield, weight) %>% as.matrix() -> response
response
...
```{r bManova-post-10, size="footnotesize"}
...
```{r bManova-post-11, size="footnotesize"}
