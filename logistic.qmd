...
This (I think) picks the most common `sex` in the data. If we add the
...
and we see that there isn't actually much difference between males and
females.

## The graph I had before
