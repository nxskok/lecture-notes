...
## CI for mean response and prediction intervals xxx
...
## The intervals xxx this doesn't work

```{r}
predictions(sleep.1, newdata = new)
predictions(sleep.1, newdata = new, interval = "p")
```
...
* Age 10 closer to centre of data, so interval is narrower than for age 5.
- Also true for representative ages, or all the ages. 
- See over.

## The `marginaleffects` package 4/6 xxx
...
## The `marginaleffects` package 5/6 xxx
...
## The `marginaleffects` package 6/6 xxx
