...
##  Tidying the data
```{r bMultiway-post-2, size="footnotesize"}
eyewear %>%
...
```{r bMultiway-post-21, message=F, size="small"}
airlines %>%
...
\footnotesize
```{r bMultiway-post-39, size="footnotesize"}
