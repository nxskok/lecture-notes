...
#  tar_render(bSurvival_slides, "bSurvival_slides.Rmd"),
  ...
  tar_target(dip, "dip.Rmd", format = "file"),
  tar_render(dip_slides, "dip_slides.Rmd"),
  ...
  tar_target(inference_2_R, "inference_2_R.Rmd", format = "file"),
  tar_render(inference_2_R_slides, "inference_2_R_slides.Rmd"),
  tar_target(inference_3_R, "inference_3_R.Rmd", format = "file"),
  tar_render(inference_3_R_slides, "inference_3_R_slides.Rmd"),
  ...
  tar_target(inference_5_R, "inference_5_R.Rmd", format = "file"),
  tar_render(inference_5_R_slides, "inference_5_R_slides.Rmd"),
...
tar_target(windmill, "windmill.Rmd", format = "file"),
tar_render(windmill_slides, "windmill_slides.Rmd"),
