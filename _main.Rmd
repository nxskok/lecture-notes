...
```{r -main-1, child="preliminaries.Rmd", echo=F}
```


```{r -main-2, child="asphalt.Rmd"}
```
...
```{r -main-3, child="preliminaries.Rmd", echo=F}
```


```{r -main-4, child="bootstrap.Rmd"}
```
...
```{r -main-5, child="preliminaries.Rmd", echo=F}
```

# Dates and times

```{r -main-6, child="dates_and_times.Rmd"}
```
...
```{r -main-7, child="preliminaries.Rmd", echo=F}
```


```{r -main-8, child="dip.Rmd"}
```
...
```{r -main-9, child="preliminaries.Rmd", echo=F}
```


```{r -main-10, child="functions.Rmd"}
```
...
```{r -main-11, child="preliminaries.Rmd", echo=F}
```



```{r -main-12, child="graphs_R.Rmd"}
```
...
```{r -main-13, child="preliminaries.Rmd", echo=F}
```


```{r -main-14, child="inference_1_R.Rmd"}
```
...
```{r -main-15, child="preliminaries.Rmd", echo=F}
```



```{r -main-16, child="inference_2_R.Rmd"}
```
...
```{r -main-17, child="preliminaries.Rmd", echo=F}
```


```{r -main-18, child="inference_3_R.Rmd"}
```
...
```{r -main-19, child="preliminaries.Rmd", echo=F}
```

```{r -main-20, child="inference_4_R.Rmd"}
```
...
```{r -main-21, child="preliminaries.Rmd", echo=F}
```

```{r -main-22, child="inference_4a_R.Rmd"}
```
...
```{r -main-23, child="preliminaries.Rmd", echo=F}
```

```{r -main-24, child="inference_4b_R.Rmd"}
```
...
```{r -main-25, child="preliminaries.Rmd", echo=F}
```



```{r -main-26, child="inference_5_R.Rmd"}
```
...
```{r -main-27, child="preliminaries.Rmd", echo=F}
```



```{r -main-28, child="inference_R.Rmd"}
```
...
```{r -main-33, child="preliminaries.Rmd", echo=F}
```


```{r -main-34, child="miscellanea.Rmd"}
```
...
```{r -main-35, child="preliminaries.Rmd", echo=F}
```


```{r -main-36, child="numsum_R.Rmd"}
```
...
```{r -main-37, child="preliminaries.Rmd", echo=F}
```

# Course outline 

```{r -main-38, child="outline_20210101.Rmd"}
```
...
```{r -main-39, child="preliminaries.Rmd", echo=F}
```


```{r -main-40, child="outline_c33_online.Rmd"}
```
...
```{r -main-41, child="preliminaries.Rmd", echo=F}
```


```{r -main-42, child="outline_c33.Rmd"}
```
...
```{r -main-43, child="preliminaries.Rmd", echo=F}
```

# Course outline 

```{r -main-44, child="outline_c32.Rmd"}
```
...
```{r -main-45, child="preliminaries.Rmd", echo=F}
```


# Reading in data

```{r -main-46, child="readfile_R.Rmd"}
```
...
- [STAC32 lecture notes](https://github.com/nxskok/notes/blob/slides_c32.pdf)
- [STAC32 R Markdown file](http://ritsokiguess.site/notes/slides_c32.Rmd)
...
```{r -main-48, child="preliminaries.Rmd", echo=F}
```

```{r -main-49, child="reports_R.Rmd"}
```
...
```{r -main-50, child="preliminaries.Rmd", echo=F}
```


```{r -main-51, child="rstan.Rmd"}
```
...
```{r -main-52, child="preliminaries.Rmd", echo=F}
```


```{r -main-53, child="running_R.Rmd"}
```
...
```{r -main-54, child="preliminaries.Rmd", echo=F}
```



```{r -main-55, child="tidying_R.Rmd"}
```
...
```{r -main-56, child="preliminaries.Rmd", echo=F}
```


```{r -main-57, child="vector_matrix.Rmd"}
```
...
```{r -main-58, child="preliminaries.Rmd", echo=F}
```


```{r -main-59, child="windmill.Rmd"}
```
...
```{r -main-60, child="preliminaries.Rmd", echo=F}
```


```{r -main-61, child="with_categ_R.Rmd"}
```
