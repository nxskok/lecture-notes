...
```{r wider-wrong-post-1, echo=FALSE}
d <- tribble(
  ~obs, ~time, ~y,
  1, "pre", 19,
  2, "post", 18,
...
```{r wider-wrong-post-4, echo=FALSE}
d2 <- tribble(
  ~subject, ~time, ~y,
  1, "pre", 19,
  1, "post", 18,
...
```{r wider-wrong-post-8, echo=FALSE}
d3 <- tribble(
  ~group, ~y,
  "control", 8,
  "control", 11,
