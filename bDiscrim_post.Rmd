...
```{r bDiscrim-post-4, include=F, message=F}
...
```{r bDiscrim-post-10, fig.height=3.4}
...
## Biplot 
```{r bDiscrim-post-36, fig.height=4.3}
...
```{r bDiscrim-post-41, include=F, message=F}
...
## Biplot
```{r bDiscrim-post-52, fig.height=3.6}
