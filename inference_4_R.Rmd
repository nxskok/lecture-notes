...
```{r inference-4-R-6, fig.height=3.3}
...
```{r inference-4-R-7, fig.height=3.5}
...
```{r inference-4-R-10, fig.height=3.1}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r inference-4-R-11, fig.height=3.1}
...
```{r inference-4-R-12, fig.height=3.3}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r inference-4-R-13, fig.height=3.4}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r inference-4-R-14, fig.height=3.4}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r inference-4-R-18, fig.height=3.7}
...
```{r inference-4-R-19, fig.height=3.2}
