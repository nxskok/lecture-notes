...
-   To run R, can use [jupyter.utoronto.ca](jupyter.utoronto.ca) (needs only web browser) or install R and R Studio on your computer. Instructions in lecture notes.
