...
## Kids learning to read (move this to the end)
...
```{r inference-4a-R-5, fig.height=1.5}
...
```{r inference-4a-R-6, fig.height=1.5}
...
```{r inference-4a-R-7, fig.height=1.5}
...
```{r inference-4a-R-10, fig.height=2.0}
...
```{r inference-4a-R-11, fig.height=2.5}
...
```{r inference-4a-R-12, fig.height=2.0}
...
```{r inference-4a-R-14, fig.height=1.5}
ggplot(d, aes(sample=x)) + stat_qq() + stat_qq_line()
```
...
```{r inference-4a-R-15, fig.height=1.5}
...
```{r inference-4a-R-16, fig.height=1.5}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r chisq-small-df, fig.height=1.5}
...
```{r inference-4a-R-17, fig.height=1.5}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
...
```{r inference-4a-R-18, fig.height=1.5}
ggplot(d,aes(sample=x))+stat_qq()+stat_qq_line()
```
