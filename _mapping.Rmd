...
![](Screenshot_2023-04-20_13-32-59.png){width=60%}
...
ontario3 %>% left_join(divisions) %>% 
  ...
  addCircleMarkers(lng = ~x, lat = ~y, 
                   color = ~pal(division)) -> divmap
```

## The map with divisions


![](Screenshot_2023-04-20_13-40-05.png)
...
![](Screenshot_2023-04-20_13-42-46.png)
